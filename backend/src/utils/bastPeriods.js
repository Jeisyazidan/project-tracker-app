...
// Merge auto-generated schedule with stored DB rows (storedRows: array from bast_periods table)
function mergePeriods(project, storedRows) {
  ...
  const autoPeriods = generated.map(g => {
    ...
    return {
      ...
      steps:           stored ? stored.steps : [false,false,false,false,false,false,false,false],
      submit_deadline: stored ? stored.submit_deadline : null,
      is_custom:       false,
    };
  });
...
module.exports = { generatePeriods, mergePeriods };
